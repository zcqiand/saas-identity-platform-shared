...
|---|---|---|---|---|---|
| M00.F01.I01 | 租户列表（平台） | 接口 | 前端+后端 | （说明待补） | 规划 |
| M00.F01.I02 | 创建租户 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M00.F01.I03 | 租户详情 / TenantGuard 校验 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M00.F01.I04 | 更新租户 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M00.F01.I05 | 删除租户 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M00.F02.I01 | 当前用户 whoami | 查询 | 前端+后端 | （说明待补） | 规划 |
| M00.F02.I02 | 列出我的租户成员关系 | 查询 | 前端+后端 | （说明待补） | 规划 |
| M00.F02.I03 | 切换当前租户 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| M01.F01.I01 | 用户列表（tenant-scoped） | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F01.I03 | 用户详情 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F01.I04 | 更新用户 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F01.I05 | 删除用户 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F01.I06 | 分配角色（用户列表入口） | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M01.F02.I01 | 分配角色 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F02.I02 | 邀请用户 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M01.F02.I03 | 状态切换 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M02.F01.I01 | 角色列表（tenant-scoped） | 接口 | 前端+后端 | （说明待补） | 规划 |
| M02.F01.I02 | 创建角色 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M02.F01.I03 | 角色详情 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M02.F01.I04 | 更新角色 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M02.F01.I05 | 删除角色 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M02.F02.I01 | 权限矩阵 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M03.F02.I03 | OIDC Code 换取 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M03.F02.I04 | refresh token | 接口 | 前端+后端 | （说明待补） | 开发中 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M03.F03.I05 | 登出（本地清理） | 接口 | 前端+后端 | （说明待补） | 开发中 |
| M03.F03.I06 | 登出（全局 SSO） | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| M04.F03.I07 | 授权码签发 | 接口 | 前端+后端 | （说明待补） | 已上线 |
| M04.F03.I08 | 令牌交换 | 接口 | 前端+后端 | （说明待补） | 已上线 |
| M04.F03.I09 | 令牌刷新 | 接口 | 前端+后端 | （说明待补） | 已上线 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M04.F01.I01 | OAuth 应用列表 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M04.F01.I02 | 创建 OAuth 应用 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M04.F01.I03 | OAuth 应用详情 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M04.F01.I04 | 更新 OAuth 应用 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M04.F01.I05 | 删除 OAuth 应用 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M04.F02.I06 | 启用/停用应用 | 接口 | 前端+后端 | （说明待补） | 开发中 |
...
| M06.F02.I04 | 留存策略设置 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M08.F01.I01 | 菜单树 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M08.F01.I02 | 创建菜单 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M08.F01.I03 | 菜单详情 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M08.F01.I04 | 更新菜单 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M08.F01.I05 | 删除菜单 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M08.F02.I06 | 同级排序 | 接口 | 前端+后端 | （说明待补） | 规划 |
| M08.F02.I07 | 切换父级 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| M09.F02.I02 | 设置角色菜单 | 接口 | 前端+后端 | （说明待补） | 已上线 |
| M09.F02.I03 | 清空角色菜单 | 接口 | 前端+后端 | （说明待补） | 规划 |
...
| 子项 ID | 名称 | 类型 | 交付 | 说明 | 状态 |
|---|---|---|---|---|---|
| M09.F01.I01 | 角色已授权菜单 | 查询 | 前端+后端 | （说明待补） | 规划 |
