...
## 7. OAuth 2.0 流程 (RFC 6749, 无 PKCE, 2026-08-29 路线 A 收口)
...
**实现细节**：ADR-0014（收口）+ ADR-0013（路线 A 批准）+ 2026-08-29 lab-aspnetcore v0.2.11 / lab-springboot v0.1.29 / saas-aspnetcore v0.3.20 修复（业务后端不再代理 authorize，改 302 跳 SSO 登录页 + /token 端点放宽 session 要求）。
